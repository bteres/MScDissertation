...
This study is carried out by first evaluating the problems associated with the Heidler function. Once this has been identified, a solution is devised. The approach taken in developing this approximation is different to the others outlined in \secref{sec:background_approximations} because the development is done in the Laplace domain and the inverse Laplace transform obtained. This is done only for the problematic part of the equation. It is then placed back into the function to create the overall approximation. This is all discussed in \chapref{ChapterApprox}
