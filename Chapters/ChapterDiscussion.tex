...
\inputtikzfig{FSpsd}{StandardFreqComparison}{Amplitude densities of the different lightning currents according to {\gls{lpl}-I} as stipulated by the IEC~62305-1 with the results of the Fourier transform of the approximation (adapted from Figure~B.5 in \cite{IEC623051}).}
