...
{
$\tau_1$ & Heidler rise time constant & \ensuremath{\mu}s \\
$\tau_2$ & Fall time constant & \ensuremath{\mu}s \\
$I_0$ & Peak current & A \\
$\eta$ & Peak current correction &  \\
$\omega_0$ & Approximation rise tiem constant & rad/s \\
$n$ & Steepness factor & \\
% Symbol & Name & Unit \\
